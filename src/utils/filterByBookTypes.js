const filterByBookTypes = (ratingFilteredBooks, bookTypeFilters) => {
    ...
    const areNoBookTypesSelected = Object.values(bookTypeFilters).every(bookTypeIsChecked => !bookTypeIsChecked);
    ...
    for(const bookTypeFilter in bookTypeFilters) {
        ...
        booksFilteredyByBookTypes = [...booksFilteredyByBookTypes, ...booksWithBookType];     
    }
