...
const RatingFilterOption = ({ ratingFilter, ratingValue }) => {
    ...
    return (
        <li className="list-item m-0-5">
            <label htmlFor={ratingFilter} className="text-sm rating-label flex-row flex-align-center">
                <input type="radio" className="input-radio" value={ratingValue} id={ratingFilter} name="product-ratings" onChange={handleRatingChange} checked={ratingsMoreThan === ratingValue} />
