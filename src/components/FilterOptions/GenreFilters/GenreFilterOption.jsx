...
const GenreFilterOption = ({ categoryName }) => {
    ...
    return (
        <li className="list-item mt-0-25 p-0-25">
            <label htmlFor={`genre-${categoryName}`}  className="text-sm genre-label flex-row flex-align-center">
                <input type="checkbox" className="input-checkbox" value={categoryName} id={`genre-${categoryName}`} onChange={handleGenreChange} checked={isGenreChecked}/>
