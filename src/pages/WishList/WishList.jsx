...
const WishList = () => {
    ...
    return (
        <main className="main wishlist-main my-2 mx-auto py-2 px-3">
            {
                loading ? <h1 className="loading text success-color my-2 text-center">Loading Wishlist Items...</h1>
                :
                        ...
                        wishListItems.length ?
                            <div className="wishlist-main-head">
                                ...
                                <section className="wishList-wrapper products-container grid grid-autofit">
                                 {
                                    wishListItems.map(wishListItem => <WishListItem key={wishListItem._id} wishListItem={wishListItem} />
                                    )
                                }
                                </section>
                            </div>
            ...
            <button className="btn btn-primary mt-2 px-0-75 py-0-25 mx-auto"><Link to="/products">
            Shop for books!</Link></button>
        </main>
    )
}
